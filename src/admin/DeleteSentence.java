...
public class DeleteSentence extends JFrame {
	...
	public void deleteSentenceUI() {
		...
		JLabel lblNewLabel = new JLabel("请输入删除的例句");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {				
				...
				try {					
					String sql = "delete from sentence where keyWord = '"+keyWord+"'";
